...
const Contact = ({ contactFun }: { contactFun: (value: boolean) => void }) => {
    ...
    return (
//     <section className="bg-white dark:bg-gray-900 absolute left-[30%] top-[100px] shadow-black  border p-2 border-gray-900">
//     <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
//     <button  onClick={() =>{contactFun(false)}}>close</button>
